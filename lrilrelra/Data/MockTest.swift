...
//        
//        do {
//            try ditto.sync.registerSubscription(query: "SELECT * FROM `scenarios`")
//        } catch {
...
//
//class MockTest {
//    @Published var publicRoomsPublisher = CurrentValueSubject<[Scenario], Never>([])
//    @Published fileprivate private(set) var allPublicRooms: [Scenario] = []
...
//        self.usersSubscription = ditto.store["scenarios"].findAll().subscribe()
//
